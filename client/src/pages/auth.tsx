  ...
  const signupMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Welcome to My Meal Planner! You have 10 free trial meals to get started.",
      });
      navigate("/");
    },
    onError: (error: any) => {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-2xl font-bold text-orange-600">My Meal Planner</span>
          </div>
